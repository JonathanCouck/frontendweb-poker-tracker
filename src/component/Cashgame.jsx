export default function Cashgame(props) {
  ...
  return (
    <div className="grid grid-cols-6 grid-row-6 border-2 border-red-500 rounded-md bg-red-200 m-1 text-left p-3 w-80">
      <b className="col-start-1 col-span-4 row-start-1 row-span-1 pb-2 text-lg"> Cashgame </b>
