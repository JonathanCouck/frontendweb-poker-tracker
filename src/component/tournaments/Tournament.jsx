...
export default function Tournament({ id, entrants, finished, buyin, cashed, date, saveTournament }) {
  ...
  const saveGame = () => {
    saveTournament(id, document.getElementById('entrants').value, document.getElementById('finished').value, document.getElementById('buyin').value, 
      document.getElementById('cashed').value, document.getElementById('date').value);
